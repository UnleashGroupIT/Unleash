...
@section('meta')
 <meta name="description" content="Unleash your people at the fastest growing Future of Work shows in the world! Join us for UNLEASH London on 20-21 March 2018.">
	  ...
	  <!-- Open Graph data -->
	<meta property="og:site_name" content="UNLEASH London - Volunteer"/>
	<meta property="og:title" content="UNLEASH London - Volunteer"/>
	...
	<meta property="og:url" content="http://www.unleashgroup.io/london/volunteer">
	...
	<meta name="twitter:title" content="UNLEASH London - Volunteer">
...
@section('title', 'London - Volunteer')

@section('headercss')
	<link rel="stylesheet" type="text/css" href="{{ mix('css/london/volunteer.css') }}">
	...
	<section class="two expo">
		<div class="content">
			<div class="content-wrap">
				...
				<p>Join UNLEASH London as a volunteer and gain unique, hands-on experience from the masters of event and conference management! You’ll act as an integral component of our show’s operations team from 19 March to 21 March 2018 inclusively, with all of your meals covered throughout this period.</p>
				...
				<p>Volunteers will receive a reference letter after completing the program.</p>
				<p>We can only accept applications with full availability between 19-21 March 2018. As part of our program, we require each volunteer to purchase a security deposit ticket. This has a cost of €50.00. The payment will only be required once the application is approved and it will be refunded after completing the program. Volunteers’ travel and accommodation costs are not covered.</p>
			</div>
			<button class="green-btn popup" data-popupdata="volunteer">Apply</button>
		</div>
		<div class="wrppr">
