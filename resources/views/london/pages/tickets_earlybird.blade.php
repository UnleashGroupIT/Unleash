...
<section id="TicketBoxes">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="expo">BOOK NOW</button>
  </div>
  ...
  <div class="TicketBox PopularTicketBox IsoBox SummerSaver TicketOne" data-category="SummerSaver">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner PopularHeader">
            <h2 class="TicketHeadline">NEW YEAR'S SPECIAL</h2>
            <h2 class="TicketPrice">&pound;1295</h2>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="earlybird">BOOK NOW</button>
  </div>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="gov">BOOK NOW</button>
  </div>
    ...
    <div class="TicketBoxHeader" >
        <div class="TicketBoxHeaderInner" id="Standard">
            ...
            <h2 class="TicketPrice">&pound;697,5</h2>
            <h3 class="TicketDeadline">UNTIL FEBRUARY 28.</h3>
            <h3 class="TicketDeadline"><input style="visibility: hidden;" type="text" class="DiscountInput" id="DiscountField" placeholder="Type it here"></h3>
        </div>
    </div>
        <div class="BoxInnerConent">
            <h3>Full Access to Exhibition Floor</h3>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="conf-expo">BOOK NOW</button>
  </div>
  ...
  <div class="TicketBox IsoBox Group TicketFour" data-category="Group">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="alacarte">CONTACT US</button>
  </div>
  <div class="PopularTicketBox IsoBox Group TicketTwo" data-category="Group">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner PopularHeader">
            ...
            <h4 id="mp" class="TicketSmallText">Save 25%</h4>
            <h4 id="hide" class="TicketSmallText">.</h4>
        </div>
    </div>
        <div class="BoxInnerConent">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="team-13">BOOK NOW</button>
  </div>
  <div class="TicketBox IsoBox Group TicketOne mobilemargin-up" data-category="Group">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="team-8">BOOK NOW</button>
  </div>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover popup" data-popupdata="team-18">BOOK NOW</button>
  </div>
  ...
  <!-- INVESTORS -->
    ...
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner">
            ...
            <h2 class="TicketPrice">&pound;595</h2>
            <h4 class="TicketSmallText">Save &pound;100</h4>
            <h3 class="TicketDeadline">Until January 31.</h3>
        </div>
    </div>
        <div class="BoxInnerConent">
