...
<section id="TicketBoxes">
  ...
  <div class="TicketBox PopularTicketBox IsoBox SummerSaver TicketOne" data-category="SummerSaver">
   ...
   <button class="TicketButton AmericasButtonInverted AmericasButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-london-formerly-hr-tech-world-tickets-34137650632#tickets', 'blank');">BOOK NOW</button>
  </div>
  ...
  <div class="TicketBox IsoBox Group TicketOne mobilemargin-up" data-category="Group">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner">
            ...
            <h2 class="TicketPrice">&pound;1,049</h2>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/hr-tech-world-london-tickets-34137650632?discount=GROUP1DEALS1LON#tickets', 'blank');">BOOK NOW</button>
  </div>
...
<div class="PopularTicketBox IsoBox Group TicketTwo" data-category="Group">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner PopularHeader">
            ...
            <h2 class="TicketPrice">&pound;979</h2>
            <h4 class="pTicket">per ticket</h4>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/hr-tech-world-london-tickets-34137650632?discount=GROUP1DEALS2LON#tickets', 'blank');">BOOK NOW</button>
  </div>
    ...
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner">
            ...
            <h2 class="TicketPrice">&pound;909</h2>
            <h4 class="pTicket">per ticket</h4>
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/hr-tech-world-london-tickets-34137650632?discount=GROUP1DEALS3LON#tickets', 'blank');">BOOK NOW</button>
  </div>
