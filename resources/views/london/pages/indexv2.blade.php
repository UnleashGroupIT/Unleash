...
<!--Future of Work-->
	...
	<!--Keynote END-->
	<section class="one-cntr mobileApp">
		<div class="wrp">
			<h2>Download App</h2>
			<p>Your guide to<br /><img src="{{ URL::asset('gfx/london/mobileApp-logo.png') }}" alt="UNLEASH" /></p>
			<div class="mobileApp--wrp">
				<a href=""><img src="{{ URL::asset('gfx/london/mobileApp-googleplay.png') }}" alt="Google Play"/></a>
				<a href=""><img src="{{ URL::asset('gfx/london/mobileApp-appstore.png') }}" alt="App Store"/></a>
			</div>
		</div>
	</section>
	<!--Speakers-->
