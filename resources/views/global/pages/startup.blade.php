...
<div id="startup-logo-wrp" class="animated">
	...
	<section class="two keynote second speakers">
		<div class="content">
			<div class="content-wrap">
				...
				<p id="orange-text">APPLICATION DEADLINE <a class="eventlink" href="/london" target="_blank">FOR LONDON</a><br />IS 26 FEBRUARY 2018.</p>
			</div>
			<div class="schedule-wrp">
	...
	<section class="one-cntr">
		<div class="wrp animated fadeInTop">
			...
			<p id="orange-text"><img src="{{ URL::asset('gfx/deadline-london.png') }}" alt="London Deadline 26 FEBR 2018"></p>
