    ...
    <div class="TimelineContainer">
        <ul id="TimelineList">
            <li class="TimeLineActive">
                <span class="SlashClassActive">/</span>SUPER SAVER<div  id="UntilSummer"> <span class="SummerSaverUntil">UNTIL</span> <br class="BRDesktop"> <span class="SummerSaverDate">JAN 31</span></div><span class="SlashClassActive">/</span></li>
...
<section id="TicketBoxes">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-london-formerly-hr-tech-world-tickets-34137650632#tickets', 'blank');">BOOK NOW</button>
  </div>-->
  ...
  <div class="TicketBox PopularTicketBox IsoBox SummerSaver TicketOne" data-category="SummerSaver">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner PopularHeader">
            ...
            <h2 class="TicketPrice">$1,295</h2>
            <h3 class="TicketDeadline">UNTIL JANUARY 31.</h3>
            <h4 class="TicketSmallText">Save $200</h4>
        ...
        <div class="BoxInnerConent">
            ...
            <h3>+ 2 nights accomodation</h3> 
       </div>
   <button class="TicketButton AmericasButtonInverted AmericasButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-america-2018-tickets-35256262430?discount=18LVSUPER#tickets', 'blank');">BOOK NOW</button>
  </div>
    ...
    <div class="TicketBoxHeader">
        ...
        <div class="BoxInnerConent">
            ...
            <h3>+ 1 night accomodation</h3>
            <ul class="BenefitUL"></ul>  
       </div>
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-america-2018-tickets-35256262430#tickets', 'blank');">BOOK NOW</button>
  </div>
  ...
  <div class="TicketBox IsoBox Group TicketThree mobilemargin-up" data-category="Group">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-america-2018-tickets-35256262430?discount=18LV5TEAM#tickets', 'blank');">BOOK NOW</button>
  </div>
  <div class="TicketBox IsoBox Group TicketOne mobilemargin-up" data-category="Group">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-america-2018-tickets-35256262430?discount=18LV8TEAM#tickets', 'blank');">BOOK NOW</button>
  </div>
...
<div class="PopularTicketBox IsoBox Group TicketTwo" data-category="Group">
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/unleash-america-2018-tickets-35256262430?discount=18LV12TEAM#tickets', 'blank');">BOOK NOW</button>
  </div>
  ...
  <!-- INVESTORS -->
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/hr-tech-world-london-tickets-34137650632?discount=18LONINVESTOR#tickets', 'blank');">BOOK NOW</button>
  </div>
  <!-- INVESTORS END -->
  ...
  <!-- STARTUP -->
   ...
   <button class="TicketButton AmsterdamButtonInverted AmsterdamButtonInvertedHover" onclick="window.open('https://www.eventbrite.com/e/hr-tech-world-london-tickets-34137650632?discount=18LONSTARTUP#tickets', 'blank');">BOOK NOW</button>
  <!-- STARTUP END -->
