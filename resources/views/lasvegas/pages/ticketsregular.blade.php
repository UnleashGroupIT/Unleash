 ...
 <div id="TimelineSingle">
    <div class="TimelineContainer">
        <ul id="TimelineList">
            ...
            <li class="TimeLineActive">REGULAR<div  id="UntilSummer"> <span class="SummerSaverUntil">UNTIL</span> <br class="BRDesktop"> <span class="SummerSaverDate">MAY 5</span></div><span class="SlashClassActive">/</span></li>
  ...
  <div class="TicketBox PopularTicketBox IsoBox SummerSaver TicketOne" data-category="SummerSaver">
    <div class="TicketBoxHeader">
        <div class="TicketBoxHeaderInner PopularHeader">
            ...
            <h2 class="TicketPrice"><span style="font-size: 75%">$</span>1,495</h2>
            <h3 class="TicketDeadline">UNTIL MAY 5.</h3>
   ...
   <a href="https://unleash.swoogo.com/unleashamerica/register?reg_type_id=21127" target="_blank"><button class="TicketButton AmericasButtonInverted AmericasButtonInvertedHover popup">BOOK NOW</button></a>
  </div>
<!--
