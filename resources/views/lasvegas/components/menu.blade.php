		<section id="header-menu" class="fixed">
			...
			<nav id="desktop-menu">
				...
				<div class="social-booknow">
					<div class="icos-wrp">
						<div><a href="https://www.youtube.com/user/hrneurope/"><img src="{{ URL::asset('gfx/lasvegas/youtube-white.png') }}" alt="Youtube"></a></div>
						<div><a href="https://www.facebook.com/hrtechworld"><img src="{{ URL::asset('gfx/lasvegas/facebook-white.png') }}" alt="Facebook"></a></div>
						<div><a href="https://www.linkedin.com/groups/3930182/profile"><img src="{{ URL::asset('gfx/lasvegas/linkedin-white.png') }}" alt="Linkedin"></a></div>
						<div><a href="https://twitter.com/hrtechworld"><img src="{{ URL::asset('gfx/lasvegas/twitter-white.png') }}" alt="Twitter"></a></div>
					</div>
					<!--Ticket button-->
